...
export const products: Product[] = [
  {
    ...
    name: "Dầu gội Bưởi Lele Sampo",
    description: "Sản phẩm chăm sóc tóc ứng dụng công nghệ enzyme sinh học kết hợp tinh chất bưởi tự nhiên Lele Sampo, giúp làm sạch da đầu, giảm gãy rụng và kích thích mọc tóc an toàn.",
    ...
    image: "/anhsanphamlele_anhsanpham.jpg",
    systemPrompt: `Bạn là trợ lý AI của sản phẩm "Dầu gội Bưởi Lele Sampo".
    Nhiệm vụ của bạn là tư vấn cho khách hàng về công dụng, thành phần và cách dùng sản phẩm dựa trên thông tin chi tiết sau:

    1. Giới thiệu: Dầu gội Bưởi Lele Sampo là sản phẩm chăm sóc tóc ứng dụng công nghệ enzyme sinh học kết hợp tinh chất bưởi tự nhiên.
    2. Thành phần chính:
    ...
    - Nhấn mạnh vào sự kết hợp giữa "Enzyme sinh học" và "Tinh chất bưởi Lele Sampo".
  ...
  },
  {
    ...
    ingredients: "Enzyme (Protease, Lipase), Chiết xuất cam tươi, Chất hoạt động bề mặt từ dừa.",
  ...
  },
  {
    ...
    name: "Nước giặt Rosely",
    description: "Giặt sạch sâu các vết bẩn cứng đầu bằng sức mạnh của enzyme, kết hợp hương hoa hồng Rosely giúp quần áo mềm mại và thơm lâu.",
    ingredients: "Enzyme (Protease, Amylase), Chất hoạt động bề mặt hữu cơ, Tinh dầu hoa hồng Rosely.",
    ...
    image: "/sanphamnuocgiatrosely_hinhsanpham.jpg",
    logo: "/sanphamnuocgiatrosely_logo.jpg",
    systemPrompt: `Bạn là trợ lý AI của sản phẩm "Nước giặt Rosely". Hãy tư vấn về khả năng giặt sạch vết bẩn, công dụng làm mềm vải và hương thơm hoa hồng Rosely quyến rũ.`
  }
];
